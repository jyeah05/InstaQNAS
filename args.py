...
optim_group.add_argument('--test_epoch', default=5, type=int, help='momentum (default=0.9)')
optim_group.add_argument('--image_size', default=300, type=int)
optim_group.add_argument('--save_iter', default=0, type=int)
...
search_group.add_argument('--reward_type', type=str, default='prec_only', choices=['prec+bops', 'prec_only', 'f1+bops', 'prec+bops_thre', 'prec+bops_thre_ori'])
